          ...
          >
            ...
            <Card
              className={cn(
                ...
                isChecked
                  ? "border-violet-300 bg-violet-50/60 shadow-[0_18px_30px_-22px_rgba(109,40,217,0.7)] ring-0 dark:border-violet-500/50 dark:bg-violet-500/10"
                  : "border-slate-200/80 bg-card/90 dark:border-border/80",
                isActive &&
                  !isChecked &&
                  "border-violet-200 bg-violet-50/30 dark:border-violet-500/30 dark:bg-violet-500/5",
              )}
            >
